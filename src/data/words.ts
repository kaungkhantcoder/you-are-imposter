    ...
    words: [
      ...
      },
      {
        ...
        hints: [
          ...
          { en: "Swimming", mm: "ရေကူးခြင်း" },
          { en: "Mammals", mm: "နို့တိုက်သတ္တဝါ" },
        ],
      },
      {
        en: "Eagle",
    ...
    words: [
      {
        ...
        mm: "ဆရာဝန်",
        hints: [
          { en: "Plus Sign", mm: "အပေါင်း" },
          { en: "Mask", mm: "မျက်နှာအုပ်" },
